...
## DAC Hardware Mute
*Last updated: 2026-07-13 (Phase 4 deferral now covers ADAT and SPDIF inputs 2/3; previously `complete_pipeline_reset()` released the mute early for those sources, un-muting before their prefill block's clock-stopping drain. Same day: flash-write fade-settle loop now services a locked ADAT input; previously the loop was skipped for ADAT and the blackout could start before the hold elapsed)*
